                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 float-end">
                                        ...
                                        <VueMultiselect v-model="customer" label="name" track-by="name" :options="customers"></VueMultiselect>
                                    </div>
                                </div>
                                <hr>
        ...
        setup(props) {
            ...
            const storeTransaction = () => {
                ...
                axios.post('/apps/transactions/store', {
                    ...
                    //send data to server
                    customer: customer.value ? customer.value.id : '',
                ...
                .then(response => {
                    ...
                    Swal.fire({
                        ...
                        setTimeout(() => {
                            ...
                            //print
                            window.open(`/apps/transactions/print?invoice=${data.invoice}`, '_blank');
