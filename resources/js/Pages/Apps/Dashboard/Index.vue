                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div v-if="hasAnyPermission(['dashboard.sales_today'])" class="card border-0 rounded-3 shadow border-top-info mb-4">
                            ...
                            <div class="card-body">
                                <strong>{{ countSalesToday }}</strong> SALES
                                <hr>
                                <h5 class="fw-bold">Rp. {{ formatPrice(sumSalesToday) }}</h5>
                            </div>
                        </div>
                        ...
                        <div v-if="hasAnyPermission(['dashboard.profits_today'])" class="card border-0 rounded-3 shadow border-top-success">
                            ...
                            <div class="card-body">
                                <h5 class="fw-bold">Rp. {{ formatPrice(sumProfitToday) }}</h5>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div v-if="hasAnyPermission(['dashboard.product_stock'])" class="card border-0 rounded-3 shadow border-top-danger">
                            ...
                            <div class="card-body">
                                <div v-if="productLimitStock.length > 0">
                                    <ol class="list-group list-group-numbered">
                                        <li v-for="product in productLimitStock" :key="product.id" class="list-group-item d-flex justify-content-between align-items-start">
...
<script>
    ...
    export default {
        ...
        props: {
            ...
            sumSalesToday: Number,

            // jumlah profit/laba hari ini
            sumProfitToday: Number,
        ...
        setup(props) {
            ...
            //chart sell week
            const chartSellWeek = {
                labels: props.salesDate,
                datasets: [{
                    data: props.grandTotal,
                    backgroundColor: randomBackgroundColor(props.salesDate.length),
                }, ],
            };
